...
public class LocacaoServiceTest {
	...
	public void naoDevAlugarFilmeSemEstoque() throws Exception{
		//cenario
		Usuario usuario = new Usuario("Usuario 1");
	...
	@Test
	public void naoDeveAlugarFilmeSeUsuario() throws FilmeSemEstoqueException{
		//cenario
		List<Filme> filmes = Arrays.asList(new Filme("Filme 1", 1, 5.0));
	...
	@Test
	public void devePagar100PctoNoFilme5() throws FilmeSemEstoqueException, LocadoraException {
		//cenario
